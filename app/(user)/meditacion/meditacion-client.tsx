...
interface MeditacionClientProps {
  classes: any[]
  bookmarkedIds: Set<string>
  userId: string
}

export function MeditacionClient({ classes, bookmarkedIds, userId }: MeditacionClientProps) {
      ...
      <main className="container mx-auto px-6 md:px-8 py-12 md:py-16">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground font-light">
            Cultiva la calma y la presencia plena
          </p>
        </div>
