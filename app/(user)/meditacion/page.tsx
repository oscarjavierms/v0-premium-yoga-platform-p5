...
// ✅ Forzamos actualización para que los cambios del Admin se vean al instante
...
export default async function MeditacionPage() {
  ...
  // TRAEMOS LOS PROGRAMAS DE MEDITACIÓN (Sincronizado con tu Admin)
  const { data: programs } = await supabase
    .from("programs")
    .select(`*, instructors(name)`)
    .eq("experience_type", "Meditación") // Filtro exacto para Meditación
    .eq("is_published", true)
    .order("created_at", { ascending: false })

  return (
    <div className="relative -mt-32">
      {/* SECCIÓN HERO: Centrada con tu imagen de meditación */}
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-32">
        {/* ENCABEZADO: Estilo idéntico a Yoga */}
        ...
        {/* GRILLA DE PROGRAMAS: Estilo Editorial unificado */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-12">
            {programs.map((program) => (
              ...
              >
                ...
                {/* Información: Nombre e Instructor */}
