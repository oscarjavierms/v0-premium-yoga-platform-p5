...
export default async function ProgramDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="min-h-screen bg-white pb-24">
      {/* Reducimos gap-8 para que el texto y el video estén más cerca */}
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-20">
        
        {/* COLUMNA IZQUIERDA: TEXTO (Aumentamos a span-5 para acercarlo al video) */}
        <div className="lg:col-span-5 pt-0">
          ...
          <div className="mt-8 space-y-6">
            <div className="space-y-3">
              ...
              {/* Quitamos max-w-sm para que el texto llegue más cerca del video */}
        ...
        {/* COLUMNA DERECHA: VIDEO (Ocupa el resto: span-7) */}
