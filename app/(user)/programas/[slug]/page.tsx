...
export default async function ProgramDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="min-h-screen bg-white pb-10 px-6 -mt-6">
      {/* ✅ AJUSTE: pt-2 en móvil para que suba casi al tope, md:pt-0 se mantiene para PC */}
      <div className="max-w-7xl mx-auto pt-2 md:pt-0">
        ...
        <section className="flex flex-col lg:grid lg:grid-cols-12 gap-8 lg:gap-16 items-start mb-8">
          ...
          <div className="lg:col-span-6 w-full order-1 lg:order-2">
            {/* -mt-2 adicional para "succionar" el video hacia el menú en móvil */}
            <div className="aspect-video bg-zinc-50 shadow-2xl overflow-hidden -mx-6 w-[calc(100%+3rem)] md:mx-0 md:w-full md:rounded-sm ring-1 ring-zinc-100 mb-8 -mt-2 md:mt-0">
              {videoSrc && <iframe src={videoSrc} className="w-full h-full border-0" allowFullScreen />}
            </div>
            
            <div className="px-0 md:px-0 mb-8 lg:mb-0">
