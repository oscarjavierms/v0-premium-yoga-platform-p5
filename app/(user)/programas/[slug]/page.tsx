...
export default async function ProgramDetailPage({ params }: { params: { slug: string } }) {
  ...
  // Lógica para detectar si es YouTube o Vimeo
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-12 gap-20">
        <div className="lg:col-span-8 space-y-12">
          <div className="space-y-6">
            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-zinc-400 block">{program.category || "Premium"}</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 py-10 border-y border-zinc-100">
            <div className="space-y-2">
              ...
              <p className="text-sm font-medium text-zinc-900">{program.focus_area}</p>
            </div>
            <div className="space-y-2">
        ...
        <div className="lg:col-span-4">
          <div className="bg-zinc-50 p-12 rounded-sm border border-zinc-100 text-center sticky top-12">
            ...
            <button className="w-full bg-zinc-900 text-white py-5 text-[10px] uppercase tracking-[0.4em] font-bold hover:bg-zinc-700 transition-all">Marcar como hecho</button>
          </div>
        </div>
      </section>
    </main>
