            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-y-8 pt-8 border-t border-zinc-100">
                 ...
                 <div>
                    ...
                    <span className="text-[10px] uppercase tracking-[0.2em] text-zinc-400 font-bold">{program.classes?.length} Clases</span>
                 </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {program.classes?.map((clase: any) => (
              <Link href={`/clases/${clase.slug}`} key={clase.id} className="group">
                ...
                <h3 className="text-[11px] font-medium text-zinc-800 leading-tight tracking-tight uppercase group-hover:text-zinc-500 transition-colors">{clase.title}</h3>
              </Link>
            ))}
          </div>
        </section>
