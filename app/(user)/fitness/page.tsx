...
export default async function FitnessPage() {
  ...
  // ✅ CONSULTA CORRECTA: Filtrar por experience_type = "Fitness"
  ...
  return (
    <div className="relative -mt-32">
      <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] overflow-hidden">
        <SectionHero 
          title="Fitness" 
          subtitle="ENTRENA TU CUERPO, FORTALECE TU MENTE" 
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-32">
        <header className="mb-12">
          <h1 className="text-5xl font-cormorant text-zinc-900 mb-2">Fitness</h1>
          <p className="text-zinc-500 font-light italic text-lg">Programas de entrenamiento diseñados para ti</p>
        </header>
        {programs && programs.length > 0 ? (
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center justify-between text-[11px] text-zinc-400 font-light tracking-wide uppercase">
                      ...
                      <span className="flex items-center gap-1.5 uppercase tracking-widest">
                        ...
                        {/* ✅ Usamos practice_level que es lo que guarda el Admin */}
          ...
          <div className="py-20 text-center border-t border-zinc-50">
            <p className="font-cormorant italic text-zinc-300 text-2xl">
              Nuevos entrenamientos en curación editorial...
            </p>
          </div>
        )}
      </div>
