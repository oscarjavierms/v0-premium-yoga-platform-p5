      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 space-y-8 bg-zinc-50/50 p-8 border border-zinc-100 sticky top-32">
          <div>
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] text-zinc-400 font-bold">{clase.difficulty || 'Moderada'}</span>
          </div>
          <div>
            <span className="block text-2xl text-zinc-800 font-cormorant italic mb-1">Pilar</span>
            <span className="text-[10px] uppercase tracking-[0.2em] text-zinc-400 font-bold">{clase.pillar || 'Cuerpo'}</span>
          </div>
        </div>
      </div>
    </main>
