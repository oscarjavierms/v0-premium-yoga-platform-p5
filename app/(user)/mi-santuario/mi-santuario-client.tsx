    ...
    <div className="min-h-screen bg-white">
      <main className="max-w-6xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="mb-16">
          ...
          <p className="text-black/60 text-lg font-light max-w-xl">
        ...
        <div className="flex flex-wrap gap-4">
          <Link
            href="/mi-practica"
            className="group inline-flex items-center gap-2 px-8 py-4 bg-black text-white rounded-full text-sm font-bold tracking-wider hover:bg-black/80 transition-all"
          >
            Mi Práctica
          ...
          <Link
            href="/explorar"
            className="group inline-flex items-center gap-2 px-8 py-4 bg-white border border-black/10 text-black rounded-full text-sm font-bold tracking-wider hover:border-black/20 hover:bg-black/[0.02] transition-all"
          >
            Explorar Clases
            <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
          </Link>
