...
export default async function InstructorPage({
  ...
  // 2) Traer clases publicadas de ese instructor
  ...
  // 3) Traer programas asociados (desde program_id en classes)
            ...
            {safeClasses.map((c) => (
              ...
              >
                <div className="flex items-center justify-between gap-6">
                  ...
                  <div className="text-xs text-black/60">Ver clase →</div>
                </div>
              </Link>
            ))}
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            {programs.map((p) => (
              ...
              >
                ...
                <p className="mt-2 text-xs text-black/60">Ver programa →</p>
              </Link>
            ))}
          </div>
        )}
